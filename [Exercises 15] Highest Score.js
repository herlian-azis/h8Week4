function highestScore (students) {
  let listClass = [];
    ...
    for (let n=0; n<listClass.length; n++) {
        ...
        findHighestScore[schoolKey] = {};
        
        findHighestScore[schoolKey].name = school[schoolKey].name[school[schoolKey].name.length-1];
        findHighestScore[schoolKey].score = school[schoolKey].score[school[schoolKey].score.length-1]
        
    }
    
    
    return findHighestScore;
}
